        ...
        with st.spinner("Processing"):
            ...
            if pdf is not None:
                ...
                if "Anglais" not in langue:
                    print("\nDeuxième appel\n")
                    texte_traduit = response_to_question("Traduis moi UNIQUEMENT ce texte :\n"+extracted_text+" mot pour mot en ANGLAIS. Donne moi uniquement le texte sans rien me dire de plus.")
                    print("\nFin Deuxième appel\n")
                ...
                print("\nQuatrième appel\n")
                ville = response_to_question("Tell me the city where the patient come from (city where he is born or where he lives) in th text below ?\n"+extracted_text+ "\nI want you to answer only with the exact name of the city as it appears in the text. Without the postal code.")
                print("\nFin Quatrième appel\n")
                ...
                - Only provide the corrected dictionary.
                """)
                ...
                problems = response_to_question(f"""
                    ...
                    -From this text : {extracted_text}
                    -Correct the list of problems I gave you without forgeting any and without repetition. 
                ...
                treatments = response_to_question(f"""
                    Here is a list of treatments I found : {str(treatments)}
                    From this text :{extracted_text}
                    -Correct the list of treatments I gave you without forgeting any and make sure there is no repetition. 
                    -I only want the list stored in a python list. I only want the corrected list. 
                    -Answer me with only the better list.
                ...
                pseudonymized_text = response_to_question(f"""
                    Based on this text : {extracted_text}
                    Here is the pseudonymized text I created : {cleaned_text}
                    With the first text and the following table :  {name_to_id}
                    -Ensure that each name present in the table has been correctly replaced by its ID in the pseudonymized text. 
                    -You must only follow this table. Do NOT replace with an ID that is not in the table. 
                    -In the text you generate, you must only pseudonymize the person who is in the table. 
                    -Their name/first name should no longer appear in the text you provide me. 
                    ...
                    -If you see an ID in the text I gave you, just ensure it correctly replaced the right person. 
                    -So if you see an ID in the text I gave you, just make sure it was done correctly. 
                    ...
                    -Give me only the well-pseudonymized text without an introduction sentence like 'Here is ...'. 
                """)
                print("\nFin Onzième appel\n")
                print(pseudonymized_text)
                print("\nDouzième appel\n")
                pseudonymized_text = response_to_question(f"""
                    From this text: {pseudonymized_text}
                    - Replace the patient's date of birth with 'DATE_DE_NAISSANCE'.
                    - Replace {ville} with 'VILLE' where it refers to the city where the patient lives or was born. Leave 'VILLE' if already correctly replaced.
                    ...
                    - Ensure names of people not pseudonymized are not cut in the middle.
                    - Keep 'DATE_DE_NAISSANCE', 'VILLE', 'CODE_POSTAL', 'ID', 'ADRESSE', 'NUMERO_DE_TELEPHONE', and 'X' as they are if they appear.
                    - If none of these changes apply, return the text as is.
                    Only return the pseudonymized text.
                    Don't add an introduction sentence.
                """)
                print("\nFin Douzième appel\n")
