    ...
    if st.button("Process"):
        with st.spinner("Processing"):
            if pdf is not None:
                ...
                ville = response_to_question("Dis moi uniquement la ville où habite le patient sans faire de phrase. Ecris moi la ville exactement comme elle apparait dans le texte. S'il y en a pas dis moi juste : Aucun",vectordb)
                ...
                #Creation du rapport médical pseudonymise
                pdf = FPDF()
                pdf.add_page()
