    ...
    if st.button("Process"):
        with st.spinner("Processing"):
            if pdf is not None:
                ...
                if langue != "Anglais.":
                    texte_traduit = response_to_question("Traduis moi uniquement le texte tout en anglais",vectordb)
                ...
                if date_de_naissance:
                    ...
                    for result in ner_results:
                        if result['word'] == date_dic[min(date_dic)]:
                            extracted_textDate.append("DATE_DE_NAISSANCE")
                        else:
                            extracted_textDate.append(result['word'])
                            
                    cleaned_text = ' '.join(extracted_textDate)
