...
def response_to_question(question,vectordb):
    ...
    llm = ChatCohere(cohere_api_key="JfDCf5c1iajr9EjmuihjzRXwidEYzR9rN95eqDU1")
...
def segment_text(text):
    # Define the segmenting pattern, e.g., sections marked by double newlines
    segments = text.split('\n\n')
