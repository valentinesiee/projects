        ...
        with st.spinner("Processing"):
            ...
            if pdf is not None:
                ...
                pseudonymized_text = response_to_question(f"""
                    ...
                    - Only answer me with the final pseudonymized text.
                    - I just want one pseudonymized text, no repetition please
                    - Don't do an introduce sentence like 'Here is...' just give the text
                """)
                print("\nFin Onzième appel\n")

                print("\nDouzième appel\n")
                pseudonymized_text = response_to_question(f"""
                    Traduct this text in french only word for word : 
                    {pseudonymized_text}
                    - Don't replace  the 'ID' or the 'X'
                    - Only answer with the text in french without comments
                    - Don't add any comments before the text I just want the text traducted
                    - Don't do an introduce sentence like 'Here is...' just give the text
                ...
                with st.container(border=True):  
                    ...
                    st.write(str(pseudonymized_text))
