...
def main(): 
    ...
    if pdf is not None:
        ...
        #Premier model pour reconnaitre les noms des patients uniquement
        ...
        #Deuxième modèle nécéssaire pour créer le dctionnaire
        ...
        #Troisième modèle pour reconnaitre les problèmes / traitements
        ...
        pseudonymized_text = response_to_question("Voici le texte synonymiser que j'ai fais : "+cleaned_text+"\nCependant à partir du texte original ainsi qu'avec la table suivante : \n"+name_to_id+" Assure toi que j'ai correctement remplacé les noms par les IDs correspondant se trouvant uniquement dans la table que je viens de te donner, donne plus d'importances à cette table, si un nom n'apparaissant pas dans ta table a été remplacé alors laisse le tel qu'il est dans le texte original. De plus si un ID apparait dans le texte alors qu'il n'est pas dans la table remplace le par le nom de base Je veux uniquement que tu me donnes le texte bien synonymisé.",vectordb)
